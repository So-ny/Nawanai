...
namespace EthanTheHero
{
	public class PlayerAttackMethod : MonoBehaviour
	{
		...
		private void BasicAttackCombo()
		{
			...
			if (Input.GetKeyDown("j") && !myAnim.GetCurrentAnimatorStateInfo(0).IsName("Attack01") && !myAnim.GetCurrentAnimatorStateInfo(0).IsName("Attack02") && !myAnim.GetCurrentAnimatorStateInfo(0).IsName("Attack03") && playerMv.grounded)
